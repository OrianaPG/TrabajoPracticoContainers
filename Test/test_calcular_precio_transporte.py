...
class test_calcular_precio_transporte(TestCase):
    ...
    def test_retira_container_en_el_puerto(self):
        ...
        empresa = Empresa()
        self.assertEqual(empresa.calcularPrecioEnvio(distancia, contenedor_completo, carga.get_peso(), False), precio_esperado)
    ...
    def test_puerta_a_puerta(self):
        ...
        empresa = Empresa()
        self.assertEqual(empresa.calcularPrecioEnvio(distancia, contenedor_completo, carga.get_peso(), True), precio_esperado)
